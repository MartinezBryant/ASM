...
begin:
    ...
    mov     rsi, [r15 + r13 * 8]    ; Move the integer into the array cell. r15 is the base address, r13 * 4 is how much address will be displaced, 4 is 4 bytes = 1 integer
    call    printf
